...
namespace Lab3
{
    ...
    public class BusinessLogic : IBusinessLogic
    {
        ...
        /// <summary>
        /// Sorts the entries by Clue column
        /// </summary>
        /// <returns>ObservableCollection of entries</returns>
        public ObservableCollection<Entry> SortByClueEntries()
        {
            return db.SortByClue();
        }

        /// <summary>
        /// Sorts the entries by Answer column
        /// </summary>
        /// <returns>ObservableCollection of entries</returns>
        public ObservableCollection<Entry> SortByAnswerEntries()
        {
            return db.SortByAnswer();
        }
